...
urlpatterns = [
    ...
    path("people/<int:pk>/update-stage/", views_people.person_update_stage, name="person_update_stage"),
    path("people/<int:pk>/interview/add/", views_people.interview_add, name="interview_add"),
    path("people/interview/<int:pk>/delete/", views_people.interview_delete, name="interview_delete"),
    path("recruitment/", views_people.recruitment_pipeline, name="recruitment_pipeline"),
    path("recruitment/jobs/", views_people.job_opening_list, name="job_opening_list"),
    path("recruitment/jobs/new/", views_people.job_opening_create, name="job_opening_create"),
    path("recruitment/jobs/<int:pk>/edit/", views_people.job_opening_edit, name="job_opening_edit"),
